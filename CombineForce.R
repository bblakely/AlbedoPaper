...
#All three
par(mar=c(5,5,5,5))
plot(Alb, ylim=c(-5,3), type='l',lwd='3', xaxt='n',yaxt='n',xlab='',ylab='', main='',cex.lab=2.2, cex.main=2.5,bty="n", col='white')
...
#little plot ylim=c(-1.8,0.8)was old version for combined plot
par(mar=c(5,6,5,5))
...
barplot(c(Alb.ann,ST.ann,SnAlb.ann,SnST.ann), col=c("gray","forest green","light blue","dark blue"), 
         font=2, ylim=c(-1.8,0.8), cex.axis=2,cex.names=2, ylab='',
...
text(labloc,0.56,c(expression(alpha),"LST",expression(alpha),"LST"), font=2, cex=2.2)
